...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2025 at 04:37 PM
...
INSERT INTO `lab` (`id`, `manufacturer`, `version`, `device`, `name`, `username`, `password`, `ip`, `port`, `config_reset`, `comment`) VALUES
(1, 'Cisco', '5.2(1)', 'nexus1000v', 'nexus1000v-1', 'admin', '19920', '10.0.0.1', 33001, 24, 'Cluster of 2 N1Kv VSM <br/>+ 1 VEM (ESXi server) <br/>+ SVS connection to vCenter appliance'),
(101, 'Radware', '27.0.0.0', 'alteon', 'alteon', 'admin', '84786', '10.0.0.101', 33101, 24, ''),
(51, 'Linux', '6.0.6', 'debian64', 'debian64', 'lab', '16044', '10.0.0.51', 33051, 24, 'debian 64 bit'),
(21, 'Juniper', '10.4R1.9', 'juniper-router', 'juniper1', 'junos', 'Jnpr33944', '10.0.0.21', 33022, 24, 'M router'),
(22, 'Juniper', '10.4R1.9', 'juniper-router', 'juniper2', 'junos', 'Jnpr68342', '10.0.0.22', 33023, 24, 'M router'),
(11, 'Cisco', '12.4(25d)', '7200', 'cisco-r1', 'cisco', '79832', '10.0.0.11', 33011, 24, 'Cisco 7200 router'),
(2, 'Cisco', '4.2(1)', 'nexus1000v', 'nexus1000v-3', 'admin', '26414', '10.0.0.3', 33002, 24, 'Standalone VSM (No VEM / SVS)'),
(13, 'Cisco', '12.4(25d)', '3640', 'cisco-r3', 'cisco', '', '10.0.0.13', 0, 24, 'Cisco 3600 router (with switch module)'),
(12, 'Cisco', '12.4(25d)', '7200', 'cisco-r2', 'cisco', '', '10.0.0.12', 33012, 24, 'Cisco 7200 router'),
(14, 'Cisco', '12.4(25d)', '3640', 'cisco-r4', 'cisco', '', '10.0.0.14', 0, 24, 'Cisco 3600 router (with switch module)'),
(4, 'VMware', '5.1', 'vCenter appliance', 'vc-appliance', '', '', '10.0.0.8', 0, 24, 'VMware vCenter 5.1 appliance'),
(15, 'Cisco', '12.4(25d)', '7200', 'cisco-r5', 'cisco', '', '10.0.0.15', 0, 24, 'Cisco 7200 router'),
(16, 'Cisco', '12.4(25d)', '7200', 'cisco-r6', 'cisco', '', '10.0.0.16', 0, 24, 'Cisco 7200 router'),
(3, 'VMware', '5.1', 'esxi 5.1 server', 'esxi-5.1', '', '', '10.0.0.5', 0, 24, 'VMware ESXi 5.1 server'),
(23, 'Juniper', '10.4R1.9', 'juniper-router', 'juniper3', 'junos', '', '10.0.0.23', 0, 0, 'M router'),
(31, 'Cisco', '12.4(25g)', '7200', 'cisco-r31', 'cisco', '', '10.0.0.31', 33031, 24, 'Cisco 7200 router'),
(32, 'Cisco', '12.4(25g)', '7200', 'cisco-r32', 'cisco', '', '10.0.0.32', 33032, 24, 'Cisco 7200 router'),
(33, 'Cisco', '12.4(25g)', '7200', 'cisco-r33', 'cisco', '', '10.0.0.33', 33033, 24, 'Cisco 7200 router'),
(34, 'Cisco', '12.4(25g)', '7200', 'cisco-r34', 'cisco', '', '10.0.0.34', 33034, 24, 'Cisco 7200 router'),
(125, 'Cisco', '3.13', 'CSR1000v', 'CSR1000v', 'admin', '0', '10.0.0.9', 0, 24, 'Cisco virtual router');
...
INSERT INTO `workers` (`id`, `username`, `password`, `privilege`) VALUES
(1, 'user', 'user', 15);
